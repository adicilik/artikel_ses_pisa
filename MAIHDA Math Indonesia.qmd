...
ringkasan <- describe(pisa_khusus, skew = FALSE, ranges = FALSE,trim=.1,
              type=3,check=FALSE,fast=NULL,quant=NULL,IQR=FALSE,omit=FALSE)
tbl_summary(pisa_idn)
kable(ringkasan)
```
...
library(gtsummary)
library(gt)
describe(pisa_khusus, skew = FALSE, ranges = FALSE,trim=.1,
              type=3,check=FALSE,fast=NULL,quant=NULL,IQR=FALSE,omit=FALSE) |> gt()
```
